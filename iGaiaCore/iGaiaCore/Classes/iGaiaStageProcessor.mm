...
void iGaiaStageProcessor::Set_Light(iGaiaLight* _light)
{
    m_light = _light;
...
void iGaiaStageProcessor::PushShape3d(iGaiaShape3d* _shape3d)
{
...
void iGaiaStageProcessor::Set_Ocean(iGaiaOcean* _ocean)
{
    if(m_ocean != nullptr)
    {
...
void iGaiaStageProcessor::PushParticleEmitter(iGaiaParticleEmitter* _particleEmitter)
{
...
void iGaiaStageProcessor::PopShape3d(iGaiaShape3d* _shape3d)
{
    iGaiaShape3d* shape3d = _shape3d;
...
void iGaiaStageProcessor::PopParticleEmitter(iGaiaParticleEmitter* _particleEmitter)
{
    iGaiaParticleEmitter* particleEmitter = _particleEmitter;
