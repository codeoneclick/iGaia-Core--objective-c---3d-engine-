...
vector<iGaiaSettingsProvider::MaterialSettings> iGaiaParser_Object3dSettingsDeserializeSettings(xml_node const& _settingsNode)
{
    vector<iGaiaSettingsProvider::MaterialSettings> materialsSettings;
    ...
    {
        iGaiaSettingsProvider::MaterialSettings materialSettings;
        ...
        iGaiaSettingsProvider::ShaderSettings shaderSettings;
        ...
        {
            iGaiaSettingsProvider::TextureSettings textureSettings;
